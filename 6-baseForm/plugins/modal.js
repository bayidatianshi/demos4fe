...
createPopBox.prototype.renderStyle = function (option) {
    ...
    // 遮罩层样式通过.ew-popBox-mask {position: fixed;left: 0;right: 0;top: 0;bottom: 0;background-color: rgba(0, 0, 0, 0.6);z-index: 10000;}实现
    ...
    // 下面这种写法要求之前没有style标签，否则之前的style会被覆盖
